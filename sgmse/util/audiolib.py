# -*- coding: utf-8 -*-
"""
taken from https://github.com/microsoft/DNS-Challenge/blob/v4dnschallenge_ICASSP2022/audiolib.py
...
def active_rms_single(clean, fs=48000, energy_thresh=-50):
    ...
    while sample_start < len(clean):
        sample_end = min(sample_start + window_samples, len(clean))
        clean_win = clean[sample_start:sample_end]
        clean_seg_rms = (clean_win**2).mean()**0.5
