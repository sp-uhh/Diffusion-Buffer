...
class NCSNpp(nn.Module):
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument("--nf",   type=int, default=128, help=" .")
        parser.add_argument("--ch_mult", nargs="+",  type=int, default=[2, 2, 2, 2, 2], help="Channel dimension per resolution. The length of the array corresponds to the number of resolutions.")        
        return parser
